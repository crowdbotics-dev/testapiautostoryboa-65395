...
## Project Structure
    ...
    ├── testapiautostoryboa_65395  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_65395`
...
2. Clone this repo and `cd testapiautostoryboa_65395`
